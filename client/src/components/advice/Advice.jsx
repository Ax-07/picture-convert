    ...
    return (
      <section id="advice" className="advice">
        ...
        <ul>
          ...
          <li>
            <strong>Choisissez les bonne Dimensions :</strong> Redimensionnez vos images pour qu'elles correspondent aux dimensions réelles à l'écran, sans utiliser de CSS pour les redimensionner. Cela permet d'éviter le chargement d'images plus grandes que nécessaire.
          </li>
          <li>
          ...
          <li>
            <strong>Activez le lazy loading :</strong> Utilisez l'attribut <code>loading="lazy"</code> sur les images pour différer le chargement des images non critiques jusqu'à ce qu'elles soient nécessaires, ce qui améliore les performances de votre site.
          </li>
          <li>
            <strong>Optimisez le texte alternatif (alt text) :</strong> Fournissez des descriptions précises et pertinentes pour améliorer l'accessibilité et le SEO.
          </li>
          <li>
            <strong>Utilisez des sprites CSS :</strong> Combinez plusieurs petites images en une seule pour réduire le nombre de requêtes HTTP et améliorer les performances de votre site.
          </li>
        </ul>
