export const Guide = () => {
  return (
    <article className="guide">
      ...
      <section>
        <h2 className="guide__sub-title">Smartphones</h2>
        <p className="guide__desc">
      ...
      <section>
        <h2 className="guide__sub-title">Tablettes</h2>
        <p className="guide__desc">
      ...
      <section>
        <h2 className="guide__sub-title">Écrans haute résolution</h2>
        <p className="guide__desc">
      ...
      <section>
        <h2 className="guide__sub-title">Densité de pixels et format WebP</h2>
        <p className="guide__desc">
      ...
      <section>
        <h2 className="guide__sub-title">Accessibilité, SEO et adaptabilité</h2>
        <p className="guide__desc">
      ...
      <section>
        <h2 className="guide__sub-title">Adaptabilité</h2>
        <p className="guide__desc">
      ...
      <section>
        <h2 className="guide__sub-title">Taille des fichiers</h2>
        <p className="guide__desc">
      ...
      <section>
        <h2 className="guide__sub-title">Exemple de code</h2>
        <p className="guide__desc">
          Voici comment vous pourriez implémenter ces recommandations dans votre
          code :
        </p>
