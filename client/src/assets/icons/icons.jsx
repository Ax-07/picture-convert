...
export const icons = {
  ...
  cloudUpload: <FontAwesomeIcon icon={faCloudUpload} color="#fff"/>,
  sliders: <FontAwesomeIcon icon={faSliders} color="#fff" />,
  download: <FontAwesomeIcon icon={faDownload} color="#fff"/>,
